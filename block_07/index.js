...
const first = 8 + 2; // uses addition to display first number in combination
const second = 10 * 4; // uses multiplication to display first number in combination
const third = 40 - 1; // uses subtraction to display first number in combination
